...
gc $file.FullName | Select-String -Context 3 -simplematch "CarsolizeService Error while refreshing room type data" 
} | Tee-Object "C:\Rocketmiles\PT_2016-11-28_Errors.txt"
